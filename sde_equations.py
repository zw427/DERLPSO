...
class SDE_Equation(Equation):
    def __init__(self, name: str, drift_template: Callable, 
                 diffusion_template: Callable, num_param: int, 
...
Heston_Model = SDE_Equation(
    ...
    num_param=4,
    param_bounds={'mu':(0.01,0.15), 'kappa':(0.5,5.0), 'theta':(0.01,0.1), 'sigma':(0.1,0.8)},
...
Lorenz_Model = SDE_Equation(
    ...
    num_param=4,
    param_bounds={'s': (5.0, 15.0), 'r': (20.0, 40.0), 'b': (1.5, 5.0), 'sigma': (1.0, 5.0)},
