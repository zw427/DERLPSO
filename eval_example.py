...
fhn.simulate_data(10000, interval, points, seed=100, train=True, over_write=False)
...
lv.simulate_data(10000, interval, points, seed=100, train=True, over_write=False)
...
# lz.simulate_data(10000, interval, points, seed=100, train=True, over_write=False)
