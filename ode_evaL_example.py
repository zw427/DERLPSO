...
if __name__ == "__main__":
    ...
    run_eval(func = FitzHugh_Nagumo, config = "Estimators/configs/fn.yaml", num_data = 100, num_state = 2, 
    ...
    run_eval(func = Lotka_Volterra, config = "Estimators/configs/lovo.yaml", num_data = 100, num_state = 2, 
    ...
    p2 = Parameter([σ, β, r])
    run_eval(func = Lorenz, config = "Estimators/configs/lv.yaml", num_data = 100, num_state = 3, 
